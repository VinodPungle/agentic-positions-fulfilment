  ...
  return (
    <div className="p-8 space-y-8">
      <div>
        ...
        <p className="font-mono text-xs text-white/40 mt-2 tracking-[0.15em]">HUMAN-IN-THE-LOOP GATE · {pending.length} PENDING IN YOUR SCOPE</p>
      </div>
        ...
        <div key={ap.id} className="border border-white/15 bg-[#121212]" data-testid={`approval-card-${ap.ticket_number}`}>
          <div className="p-5 border-b border-white/15 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button onClick={() => decide(ap, "approve")} disabled={!canApprove} data-testid={`approve-button-${ap.ticket_number}`} className="bg-[#32D74B] hover:bg-[#28B33E] text-black rounded-sm">Approve</Button>
